...
DECLARE_GL_FUNCTION(glDebugMessageCallback, void, (GLDEBUGPROC callback, const void *userParam))
#define glDebugMessageCallback USE_GL_FUNCTION(p_glDebugMessageCallback)
